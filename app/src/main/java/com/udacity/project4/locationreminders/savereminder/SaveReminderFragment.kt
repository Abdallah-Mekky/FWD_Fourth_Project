...
class SaveReminderFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.saveReminder.setOnClickListener {
            ...
            if (latitude != null && longitude != null && !TextUtils.isEmpty(title))
                geofenceReminder(LatLng(latitude, longitude), geofenceId)


            reminderDataItem =   ReminderDataItem(title,description,location,longitude,latitude,geofenceId)
    ...
    private fun geofenceReminder(
        ...
        val geofenceClient = LocationServices.getGeofencingClient(requireContext())

        geofenceClient.addGeofences(geofencingRequest, pendingIntent)?.run {
            ...
            addOnFailureListener { e ->
                ...
                Toast.makeText(context, "Problem in adding geofences", Toast.LENGTH_LONG).show()
            }
        }
    }
